...
getShareUrl() {
    ...
    echo "vless://${xray_uuid}@${xray_userDomain}:443?encryption=none&security=tls&sni=${xray_userDomain}&type=xhttp&host=${xray_userDomain}&path=${encoded_path}#${xray_userDomain}"
}
